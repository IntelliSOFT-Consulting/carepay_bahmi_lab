    ...
    try {
      ...
      if (_jspx_eval_html_005fhtml_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          // /pages/common/formTemplate.jsp(16,0) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
          _jspx_th_bean_005fdefine_005f0.setId("formName");
          // /pages/common/formTemplate.jsp(16,0) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if (form == null) {
  ...
  if (request.getAttribute("startingRecNo") != null) {
   ...
   request.setAttribute("ctx", request.getContextPath());
          ...
          out.write("\n");
          out.write("\n");
          out.write("function setAction(form, action, validate, parameters) {\n");
          out.write("    //alert(\"Iam in setAction \" + form.name + \" \" + form.action);\n");
          out.write("   //for (var i = 0; i < form.elements.length; i++) {\n");
          out.write("\n");
          out.write("      //alert(\"This is a form element \" + form.elements[i].name + \" \" + form.elements[i].value);\n");
          out.write("\n");
          out.write("    //}\n");
          out.write("\n");
          ...
          out.write("\t//alert(\"form name \" + formName);\n");
          out.write("\tvar parsedFormName = formName.substring(1, formName.length - 4);\n");
          out.write("\tparsedFormName = formName.substring(0,1).toUpperCase() + parsedFormName;\n");
          out.write("    //alert(\"parsedFormName \" + parsedFormName);\n");
          out.write("\n");
          out.write("    var idParameter = '");
          out.print( (String)request.getParameter("ID") );
          out.write("';\n");
          out.write("    var startingRecNoParameter = ");
          out.print( (String)request.getParameter("startingRecNo"));
          out.write(";\n");
          out.write("    //alert(\"This is idParameter \" + idParameter);\n");
          out.write("    if (!idParameter) {\n");
          out.write("       idParameter = '0';\n");
          out.write("    }\n");
          out.write("\n");
          out.write("    if (!startingRecNoParameter) {\n");
          out.write("       startingRecNoParameter = '1';\n");
          out.write("    }\n");
          out.write("\n");
          out.write("    if (parameters != '') {\n");
          out.write("\t   parameters = parameters + idParameter;\n");
          out.write("\t} else {\n");
          out.write("\t   parameters = parameters + \"?ID=\" + idParameter;\n");
          out.write("\t}\n");
          out.write("    parameters = parameters + \"&startingRecNo=\" + startingRecNoParameter;\n");
          out.write("\n");
          out.write("\n");
          out.write("\tform.action = context + '/' + action + parsedFormName + \".do\"  + sessionid + parameters ;\n");
          out.write("\tform.validateDocument = new Object();\n");
          out.write("\tform.validateDocument.value = validate;\n");
          out.write("\t//alert(\"Going to validatedAnDsubmitForm this is action \" + form.action);\n");
          out.write("\tvalidateAndSubmitForm(form);\n");
          out.write("\n");
          out.write("}\n");
          out.write("\n");
          out.write("//default behavior -- overide for behavior\n");
          out.write("function /*boolean*/ handleEnterEvent(){\n");
          out.write("\treturn true;\n");
          out.write("}\n");
          out.write("\n");
          out.write("function enterIntercepter(e) {\n");
          out.write("\tvar code = e ? e.which : window.event.keyCode;\n");
          out.write("\tif( code == 13){\n");
          out.write("\t\treturn handleEnterEvent()\n");
          out.write("\t}\n");
          out.write("\t\n");
          out.write("\treturn true\n");
          out.write("}\n");
          out.write("document.onkeypress = enterIntercepter;\n");
          out.write("if (document.layers) {\n");
          out.write("\tdocument.captureEvents(Event.KEYPRESS);\n");
          out.write("}\n");
          out.write("</script>\n");
	...
	if (request.getAttribute("cache") != null && request.getAttribute("cache").toString().equals("false"))
	{
          ...
          // /pages/common/formTemplate.jsp(134,2) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
          ...
          if (_jspx_eval_logic_005fnotEmpty_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            do {
              ...
              // /pages/common/formTemplate.jsp(135,3) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_bean_005fwrite_005f0.setName(IActionConstants.PAGE_TITLE_KEY);
              // /pages/common/formTemplate.jsp(135,3) name = scope type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
          ...
          // /pages/common/formTemplate.jsp(137,2) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
          ...
          out.write('\n');
          out.write("\n");
          out.write("<body onLoad=\"focusOnFirstInputField();check_width();onLoad()\" >\n");
          out.write("\n");
          out.write("\n");
          out.write("\n");
          out.write("<!-- for optimistic locking-->\n");
          //  html:hidden
          ...
          // /pages/common/formTemplate.jsp(154,0) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
          _jspx_th_html_005fhidden_005f0.setProperty("lastupdated");
          // /pages/common/formTemplate.jsp(154,0) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
 ...
 if (request.getAttribute(IActionConstants.ACTION_KEY) != null) { 
          ...
          out.write("' action='");
          out.print((String)request.getAttribute(IActionConstants.ACTION_KEY) );
 ...
 if (request.getAttribute(IActionConstants.ACTION_KEY) != null) { 
  ...
  private boolean _jspx_meth_tiles_005finsert_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fhtml_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /pages/common/formTemplate.jsp(141,1) name = attribute type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_tiles_005finsert_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fhtml_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /pages/common/formTemplate.jsp(142,4) name = attribute type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_tiles_005finsert_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fhtml_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /pages/common/formTemplate.jsp(158,5) name = attribute type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_tiles_005finsert_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fhtml_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /pages/common/formTemplate.jsp(166,5) name = attribute type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_tiles_005finsert_005f4(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fhtml_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /pages/common/formTemplate.jsp(171,5) name = attribute type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_tiles_005finsert_005f4.setAttribute("preSelectionHeader");
  ...
  private boolean _jspx_meth_tiles_005finsert_005f5(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fhtml_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /pages/common/formTemplate.jsp(176,11) name = attribute type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_tiles_005finsert_005f5.setAttribute("body");
  ...
  private boolean _jspx_meth_tiles_005finsert_005f6(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fhtml_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
          throws java.lang.Throwable {
    javax.servlet.jsp.PageContext pageContext = _jspx_page_context;
    javax.servlet.jsp.JspWriter out = _jspx_page_context.getOut();
    //  tiles:insert
    ...
    // /pages/common/formTemplate.jsp(181,5) name = attribute type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
